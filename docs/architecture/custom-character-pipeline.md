...
without control or bidirectional-formatting characters. One bounded UTF-8
projection shared by the live custom roster and Workshop preserves printable
ASCII; deterministically folds common Latin diacritics and ligatures, attached
