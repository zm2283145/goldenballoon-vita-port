...
| Share responsibly | Executable for authenticated no-overwrite portable export and receiving-build compatibility, rights/provenance, identity, gameplay, rig, animation, LOD, memory, and installed-version review before local consent | Bulk draft transfer and online package negotiation/privacy |
