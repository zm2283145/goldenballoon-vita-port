...
1. Donor-reference occlusion and weather/vehicle conditions beyond the
   qualified open/dense/alternate course batteries still
...
Select and vehicle fit approval use the source-and-fit-bound v6 contact-stability
...
Named-draft v17 and Fit-history v8 preserve the new meaning. Every older
approval reopens once rather than silently upgrading evidence without the
three-course and settled contact-stability contracts.
