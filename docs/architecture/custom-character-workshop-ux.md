...
style, six-treatment comparison, and pixel stages. An embedded renderer,
model-only transparent capture, freeform subject masks, and contact overlays
remain.
