...
2. Anatomical joint-limit inspection, optional deterministic secondary motion,
   and full controller plus screen-reader traversal of Animation
   Studio/freeform gestures remain. The 13-state bounded reference library is
   complete; package-specific artistic review remains intentionally mandatory.
...
Authored joint-limit inspection, optional deterministic secondary motion, and
