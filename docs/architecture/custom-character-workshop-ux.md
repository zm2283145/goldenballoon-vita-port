...
7. The high-fidelity renderer tail remains explicit: modern characters do not
   ...
   ordering; KTX2/BasisU import is absent; optional recorded simplification is
   absent; and
