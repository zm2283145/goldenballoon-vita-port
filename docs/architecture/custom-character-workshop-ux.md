...
directly to bounded Portrait Studio crop, matte, background, style,
six-treatment comparison, and pixel stages. An embedded renderer, freeform
subject masks, and contact overlays remain.
...
Studio; freeform subject/background composition and localization-aware
game-font shaping remain.
