...
1. Opaque-depth visibility/donor-reference occlusion, attachments,
   representative course/vehicle/motion conditions, and unusual-proportion
   fixtures need qualified evidence contracts before the Workshop can
   diagnose them. Closed-volume containment is now qualified and bounded;
   transparent occlusion and unsampled geometry remain explicitly outside it.
