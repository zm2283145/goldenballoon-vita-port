...
carried forward by v6 evidence.
Result v16 additionally walks the exact selected-LOD posed character triangles
...
and the first intersecting triangle centre in authenticated v6 evidence. A
clear sample proves only that sampled surface set; a reported contact is amber
because intended hand/foot contact, coplanar contact, and penetration are not
distinguishable without depth/volume evidence. Separately attached wheels and
props, depth-buffer visibility, containment, penetration depth, and motion
between sampled poses remain explicit composed-scene review items.
