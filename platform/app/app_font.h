// app_font.h — embedded UI font (generated by lib/imgui binary_to_compressed_c).
// Source: Roboto-Medium.ttf (Google, Apache-2.0) — see lib/fonts/LICENSE.txt.
// The .ttf byte source is NOT tracked (the repo tracks no binary blobs); this
// compressed-base85 header is the build input. Regenerate by fetching
// Roboto-Medium.ttf (from the upstream Roboto repo or Dear ImGui misc/fonts) and:
//   binary_to_compressed_c -base85 Roboto-Medium.ttf RobotoMedium > src/app/app_font.h
#ifndef MDKR_APP_FONT_H
#define MDKR_APP_FONT_H
// File: 'lib/fonts/Roboto-Medium.ttf' (162588 bytes)
// Exported using binary_to_compressed_c.exe -base85 "lib/fonts/Roboto-Medium.ttf" RobotoMedium
