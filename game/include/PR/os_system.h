...
/*
 * os_system.h — clean-room boot and system-level declarations.
 *
 * Declares the globals and entry points this port uses for startup and
 * reset (region, reset cause, ROM location, clock rate, memory size)
 * and the top-level osInitialize/osExit calls. This is a
