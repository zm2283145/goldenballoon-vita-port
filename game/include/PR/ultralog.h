/*
 * ultralog.h — clean-room event-log declarations.
 *
 * Declares OSLog, a lightweight ring-buffer event log, along with the
 * entry points to create one, append timestamped records to it, and
 * flush or print its contents; this is a declaration-only compatibility
