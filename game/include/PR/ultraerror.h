/*
 * ultraerror.h — clean-room diagnostic error-code declarations.
 *
 * Enumerates the ERR_* codes the audio library passes to __osError
 * when it detects an out-of-range condition, along with the error
 * handler hook itself; this is a declaration-only compatibility
