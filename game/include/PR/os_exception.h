...
/*
 * os_exception.h — clean-room event codes and exception-message
 * registration declarations.
 *
 * Declares the interrupt mask type and the bitmasks used to enable
 * combinations of hardware interrupt sources, along with the entry points
 * for reading and installing the active interrupt mask. Declaration-only
