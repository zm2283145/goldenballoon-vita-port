...
/*
 * os_pfs.h — clean-room controller-pak filesystem declarations.
 *
 * Declares the record layout and calls this port uses to allocate,
 * find, read, write and repair files on a controller pak, plus the
 * pak-checking and label/status helpers built on top of them. This is
 * a declaration-only compatibility surface — no vendor implementation
 * is present.
 */
