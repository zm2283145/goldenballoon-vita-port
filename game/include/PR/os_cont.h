...
/*
 * os_cont.h — clean-room controller polling, status and pak detection
 * declarations.
 *
 * Declares the controller-bus interface: initializing and resetting the
 * bus, querying attached controller types and status (including accessory
 * pak presence), and reading button/stick state. Declaration-only
 ...
 * mm_malloc.h), so leaving it undefined for the rest of the TU breaks the CRT
...
/* Common aliases for the button/pad bits above */
