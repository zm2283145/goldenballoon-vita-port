...
/*
 * os_thread.h — clean-room cooperative-thread declarations.
 *
 * Declares the thread control block, its saved register context, and
 * the calls this port uses to create, start, stop, and schedule
 * threads by priority. This is a declaration-only compatibility
