/*
 * os_internal_reg.h — clean-room internal coprocessor-register
 * declarations.
 *
 * Declares the private accessors the OS layer uses to read and write
 * CP0 registers (cause, compare, config, count, status, watch-lo) and
 * the floating-point control/status register; this is a
