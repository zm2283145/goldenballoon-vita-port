...
// LP64: align through uintptr_t so the aligned framebuffer keeps its full 64-bit
// host address (the (s32) form truncated it; identical bit pattern on N64).
#define FBALIGN(a) ((u16 *) (((uintptr_t) (a) + 0x3F) & ~(uintptr_t) 0x3F))
