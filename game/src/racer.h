...
#ifdef NATIVE_PORT
/* Fidelity Phase 2b (census item 8): the held-object convergence lerp, hoisted out
 * of render_3d_model so it runs once per authoritative tick instead of once per
 * draw. See racer.c. */
