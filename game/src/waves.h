...
#ifdef NATIVE_PORT
/* Fidelity Phase 2b (P0): authoritative half of waves_update -- wave phase,
 * wave generators and global wave strength, all read back by racer buoyancy.
 * Called once per authoritative tick, immediately before render_scene.
 * See waves.c and docs/RENDER_MUTATION_CENSUS_2026-07-29.md. */
void waves_tick(s32 updateRate);
extern u32 gWaveBlockCount; /* tracks.c -- non-zero when the level has waves */
#endif
